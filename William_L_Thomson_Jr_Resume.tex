...
\begin{description}[style=multiline,leftmargin=11em]
  ...
  (ALE) and OpenCV  (\href{https://github.com/wltjr/q-space_invaders}{link})
  ...
  \item [mahse] Multi-Agent Hedonic Simulation Environment, task coalition formation algorithm research in C++. (\href{https://github.com/wltjr/mahse}{link})
